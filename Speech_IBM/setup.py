...
def on_message(self, msg):
    ...
    if "results" in data:
        ...
        global word
        word = data['results'][0]['alternatives'][0]['transcript']
...
def get_url():
    ...
    return ("wss://api.au-syd.speech-to-text.watson.cloud.ibm.com/instances/26b7ef3f-545e-4bba-a702-a2d34214417d/v1/recognize")
